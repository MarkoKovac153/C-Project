...
int main(int argc, char *argv[]) {
    ...
    usize player_id = entity_create((vec2){200, 200}, (vec2){100,100}, (vec2){0,0}, COLLISION_LAYER_PLAYER, player_mask, player_on_hit, player_on_hit_static);
    ...
    usize entity_a_id = entity_create((vec2){600,600}, (vec2){50, 50}, (vec2){100, 0}, COLLISION_LAYER_ENEMY, enemy_mask, NULL, enemy_on_hit_static);
    usize entity_b_id = entity_create((vec2){900,600}, (vec2){50, 50}, (vec2){-100, 0}, COLLISION_LAYER_ENEMY, enemy_mask, NULL, enemy_on_hit_static);
